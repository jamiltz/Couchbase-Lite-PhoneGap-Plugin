...
Congrats, you got to hello world. If you want to try a full example app, [follow the instructions for 5 minutes to awesome](http://developer.couchbase.com/mobile/get-started/get-started-mobile/phonegap/index.html)
